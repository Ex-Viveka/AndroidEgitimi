...
public class CameraActivity extends AppCompatActivity {
    ...
    private final int REQUEST_IMAGE_CAPTURE_AT_FULL_SIZE = 1002;
    private final int REQUEST_GALLERY = 612;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bCapture.setOnClickListener(multimediaClickListener);
        bCaptureFullSize.setOnClickListener(multimediaClickListener);
        bFromGallery.setOnClickListener(multimediaClickListener);
    }

    private View.OnClickListener multimediaClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            if (v == bCapture) {
                getThumbnailFromCamera();
    ...
    private void getThumbnailFromCamera() {
    ...
    private void getFullSize() {
        ...
        startActivityForResult(intent, REQUEST_IMAGE_CAPTURE_AT_FULL_SIZE);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            } else if (requestCode == REQUEST_IMAGE_CAPTURE_AT_FULL_SIZE) {
...
//                }
            ...
            Log.d(TAG, "Your operation is not ok");
        }
